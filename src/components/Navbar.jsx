...
const Navbar = () => {
    ...
    return(
        <header className="sticky top-0 z-50 w-full border-b bg-backgroudn/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 lg:px-0">
            <div className='max-w-7xl mx-auto flex h-14 items-center'>
                <div className="md:mr-4 flex justify-between w-full">
                    ...
                    <nav className="md:flex hidden items-center space-x-6 text-lg font-medium">
                        ...
                        <a href="#testimonial" className="transition-colors hover:text-foreground/80 text-foreground/60">Testimonials</a>
            ...
            {mobileMenuOpen && (
                <div className="md:hidden">
                    <div className="space-y-1 px-2 pb-3 pt-2">
                        ...
                        <a href="#contacts" className="block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900">Contacts</a>
                    </div>
                </div>
            )}
        </header>
